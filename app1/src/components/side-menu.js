    ...
    'subMenu':[
      {
        ...
        'activePath':['accounts-overview']
      }, {
        'title':'认证管理',
        'route':{name: 'accounts-auth'},
        'activePath':['accounts-order-detail']
      }, {
        'title':'云使者管理',
        'route':{name: 'accounts-envoy'}
      }
    ]
  },
  {
    ...
    'subMenu':[
      ...
      // }, {
      //   'title':'*规则管理',
      //   'route':{name: 'offerings-rule'}
      // }, {
      //   'title':'*用户规则',
      //   'route':{name: 'offerings-user'},
      }, {
        'title':'大客户折扣',
